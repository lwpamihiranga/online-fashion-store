        ...
        return(
            <div className="registerContainer">
                <div className="inputFieldContainer">
                    ...
                    <input className="form-control  mx-auto d-block mt-4 w-75 p-3" aria-label="Default" type="text" placeholder="Username"/>
                    <input className="form-control  mx-auto d-block mt-2 w-75 p-3" aria-label="Default" type="text" placeholder="Email"/>
                    <input className="form-control  mx-auto d-block mt-2 w-75 p-3" aria-label="Default" type="password" placeholder="Password"/>
