        ...
        return(
            <div className="loginContainer">
                <div className="inputFieldContainer">
                    ...
                    <input class="form-control  mx-auto d-block mt-4 w-75 p-3" aria-label="Default" type="text" value={this.state.username}  onChange={(e)=> this.setState({username:e.target.value})} placeholder="Username"/>
