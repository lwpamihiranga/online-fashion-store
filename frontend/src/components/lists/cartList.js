            ...
            return (
                <div>
                    <Link to={'/product/' + product._id} style={{ textDecoration: 'none' }}>
                        <div className="productItem" key={product._id}></div>
                    ...
                    <input
                        ...
                        type="button"
                        value="Buy"
                        onClick={() => this.buyProduct(userid, product._id)}
                    />
                    <input
                        className="btn btn-primary mt-2 mx-auto d-block  w-75"
                        type="button"
                        value="Remove"
                        onClick={() => this.removeProductFromCart(userid, product._id)}
                    />
                </div>
            );
        });
