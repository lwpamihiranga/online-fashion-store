                ...
                <div className="col-md-3 col-sm-6 col-xs-6 mb-4" key={product._id}>
                    <div className="card">
                        <div className="card-body">
                            <div key={product._id} className="row d-flex justify-content-center">
                                <img src={url} alt="..." className="img-responsive p-1 productImg" />
                            </div>
                            <strong>
                            ...
                            {product.discount === '' ||
                                (product.discount <= 0 && (
                                    <strong>
                                        <p className="font-weight-bold">{'LKR ' + product.price + '/='}</p>
                                    </strong>
                                ))}
                            ...
                            {isWishList && (
                                <div>
                                    <input
                                        ...
                                        type="button"
                                        value="Add to Cart"
                                        onClick={() => this.addToCart(LoginState.getUserId(), product._id)}
                                    />
                                    <input
                                        className="btn btn-primary mt-2 mx-auto d-block w-100"
                                        type="button"
                                        value="Remove"
                                        onClick={() =>
                                            this.removeProductFromWishList(LoginState.getUserId(), product._id)
                                        }
                                    />
                                </div>
                            )}
                                ...
                                <div>
                                    {!product.isBought && (
                                        <button className="btn btn-primary mt-2 mx-auto d-block w-100">
                                            <NavDropdown
                                                title={
                                                    <strong className="dropDownTitle ml-1">
                                                        {' '}
                                            ...
                                            >
                                                ...
                                                <button
                                                    className="dropDownButton"
                                                    onClick={() =>
                                                        this.buyProduct(product._id, BuyMethod.CashOnDelivery)
                                                    }
                                                >
                                                    <NavDropdown.Item>{'Cash on Delivery'}</NavDropdown.Item>
                                                </button>
                                            </NavDropdown>
                                        </button>
                                    )}
                                    {product.isBought && (
                                        <button
                                            className="btn btn-primary mt-2 mx-auto d-block w-100 disableButton"
                                            disabled
                                        >
                                            <strong className="dropDownTitle ml-1">
                                                {' '}
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="row d-flex justify-content-center">
                                        <img src={image} alt="..." className="img-responsive p-1 productImg" />
                                    </div>
                                    <strong>
                                        <p className="font-weight-bold">{'GIVE THE PRODUCT AN ATTRACTIVE NAME'}</p>
                                    </strong>
                                    <strong>
                                        <p className="font-weight-bold">Price and Discount</p>
                                    </strong>
                                    <div>
